...
public class FullMatchMethodTraceAdviceImpl extends AbstractMethodTraceCommandAdvice {

    public FullMatchMethodTraceAdviceImpl(int context, String className, String method, String desc,
    ...
    protected boolean allowToEnd(Object[] args, Object retVal, Throwable throwable, String cls, String method, String desc) {
        return remoteCommand.needStop() || checkOwn(cls, method, desc);
    }
