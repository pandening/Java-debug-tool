...
/**
 * Created on 2019/4/23 15:15.
 *
 * @author <a href="H.J"> HuJian </a>
 */
@CommandDescribe(name = "exit", simpleName = "exit", function = "退出客户端，如果是master console，会做一些微妙的处理",
        usage = "exit", cmdType = CommandType.COMPUTE
)
public class ExitCommand implements Command {
    ...
    public String execute(Instrumentation ins, RemoteCommand reqRemoteCommand, CommandServer commandServer, ServerHook serverHook) throws Exception {
        reqRemoteCommand.addParam("$back-close-tag", "true");
        return "bye~\n";
    }
