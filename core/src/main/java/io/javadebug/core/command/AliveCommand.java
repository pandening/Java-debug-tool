...
@CommandDescribe(name = "alive", simpleName = "check",
        function = "command client will execute this command to tell server alive status",
        usage = "alive", cmdType = CommandType.COMPUTE
)
