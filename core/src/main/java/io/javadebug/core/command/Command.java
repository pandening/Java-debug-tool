...
public interface Command {
     ...
     */
    boolean preExecute(RemoteCommand remoteCommand) throws Exception;
     ...
     * @return 响应命令
     */
    String execute(Instrumentation ins, RemoteCommand reqRemoteCommand, CommandServer commandServer, ServerHook serverHook) throws Exception;
     ...
     */
    boolean stop(Instrumentation ins, RemoteCommand reqRemoteCommand, CommandServer commandServer, ServerHook serverHook) throws Exception;
