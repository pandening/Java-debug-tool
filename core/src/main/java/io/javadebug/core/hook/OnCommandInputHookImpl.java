...
public class OnCommandInputHookImpl implements DefaultHookImpl<String, Void> {
    ...
    public Void apply(String s) {
        ...
        try {
            ...
            PSLogger.error("error when consume command-input msg:" + s + " with exception : " + e);
        }
    ...
    public boolean isInterest(RuntimeStage stage) {
        return stage.equals(RuntimeStage.COMMAND_INPUT);
    }
}
