...
/**
 * One or more variables that together maintain a running {@code long} maximum with initial value {@code Long.MIN_VALUE}. When updates
 * (method {@link #update}) are contended across threads, the set of
 * variables may grow dynamically to reduce contention. Method {@link #max} (or, equivalently, {@link #longValue}) returns the current
...
public class LongMaxUpdater extends Striped64 implements Serializable {
    ...
    /**
     * Creates a new instance with initial maximum of {@code Long.MIN_VALUE}.
     */
    ...
    /**
     * Equivalent in effect to {@link #max} followed by {@link #reset}. This method may apply for example during quiescent
    ...
    /**
     * Returns the {@link #max} as a {@code float} after a widening primitive conversion.
     */
